...
// Example network data with additional details
const networkData = {
  id: '0',
  name: 'Тимур Есенов',
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Card className="p-3 shadow-none bg-white/95 hover:bg-white transition-all duration-200 hover:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)]">
              <div className="flex items-center space-x-3">
